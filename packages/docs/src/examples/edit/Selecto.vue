...
METHODS.forEach((name) => {
  methods[name] = function (this: any, ...args: any[]): any {
...
PROPERTIES.forEach((name) => {
  watch[name] = function (this: any, value: any): any {
...
interface VueSelecto
  extends MethodInterface<SelectoMethods, VanillaSelecto, VueSelecto>, Partial<SelectoOptions> {}
