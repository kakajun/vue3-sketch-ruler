'use strict'
/*!vue3-sketch-ruler v1.3.132024年1月Fri Jan 05 2024 21:16:54 GMT+0800 (中国标准时间)制作*/ Object.defineProperties(
  exports,
  ...
  z = c.defineComponent({
    ...
    setup(e, { emit: t }) {
      ...
      const u = (o) => {
        ...
        d = c.computed(() => {
          const o = (r.value - e.start) * e.scale
          u(o)
          const h = o + 'px'
  ...
  return n.withDirectives(
    ...
    n.createElementBlock(
      'div',
      {
        ...
        onMousedown: t[1] || (t[1] = (...l) => e.handleDown && e.handleDown(...l))
      },
      [
        n.createElementVNode(
          ...
          [
            n.createElementVNode(
              ...
              {
                class: 'del',
                onClick: t[0] || (t[0] = (...l) => e.handleRemove && e.handleRemove(...l))
              },
              '×'
            ),
...
const M = B(z, [
  ...
  K = c.defineComponent({
    ...
    setup(e, { emit: t }) {
      const r = c.reactive({ canvasContext: null })
      let i = 1
      const u = c.ref(null)
      c.onMounted(() => {
        ;(i = e.ratio || window.devicePixelRatio || 1), d(), l(i), m(i)
      })
      const d = () => {
          r.canvasContext = u.value && u.value.getContext('2d')
        },
        l = (a) => {
          if (u.value) {
            ;(u.value.width = e.width * a), (u.value.height = e.height * a)
            const o = r.canvasContext
            o &&
        ...
        m = (a) => {
          ...
          r.canvasContext &&
            F(r.canvasContext, e.start, e.selectStart, e.selectLength, o, !e.vertical)
        }
      return (
        c.watch(
          () => e.start,
  ...
  return (
    ...
    n.createElementBlock(
      'canvas',
      {
        ref: 'canvas',
        class: 'ruler',
        onClick: t[0] || (t[0] = (l) => e.handle(l, 'click')),
        onMouseenter: t[1] || (t[1] = (l) => e.handle(l, 'enter')),
        onMousemove: t[2] || (t[2] = (l) => e.handle(l, 'move')),
        onMouseleave: t[3] || (t[3] = (l) => e.$emit('update:showIndicator', !1))
      },
      null,
      544
    )
...
const H = c.defineComponent({
  ...
  W = { class: 'lines' },
  Z = { class: 'value' }
function j(e, t, r, i, u, d) {
  const l = n.resolveComponent('CanvasRuler'),
...
const te = c.defineComponent({
    ...
    setup(e, { emit: t }) {
      ...
      const i = c.computed(() => {
        ...
        u = c.computed(() => ({
          backgroundImage: r.value ? `url(${e.eyeIcon || _})` : `url(${e.closeEyeIcon || x})`,
          width: e.thick + 'px',
          height: e.thick + 'px',
      ...
      return (
        ...
        { showReferLine: r, paletteCpu: i, cornerStyle: u, onCornerClick: d }
      )
    }
  }),
  ne = { id: 'mb-ruler', class: 'style-ruler mb-ruler' }
function oe(e, t, r, i, u, d) {
  const l = n.resolveComponent('RulerWrapper')
  return (
    n.openBlock(),
