...
var render$3 = function() {
  ...
  return _c("div", { directives: [{ name: "show", rawName: "v-show", value: _vm.showLine, expression: "showLine" }], staticClass: "line", style: [_vm.offset, _vm.borderCursor], on: { "mousedown": _vm.handleDown } }, [_c("div", { staticClass: "action", style: _vm.actionStyle }, [_c("span", { staticClass: "del", on: { "click": _vm.handleRemove } }, [_vm._v("\xD7")]), _c("span", { staticClass: "value" }, [_vm._v(_vm._s(_vm.startValue))])])]);
};
...
var __component__$3 = /* @__PURE__ */ normalizeComponent(__vue2_script$3, render$3, staticRenderFns$3, false, __vue2_injectStyles$3, "7d1eeed0", null, null);
...
var render$2 = function() {
  ...
  var _h = _vm.$createElement;
  var _c = _vm._self._c || _h;
  return _c("canvas", { ref: "canvas", staticClass: "ruler", on: { "click": function($event) {
...
var render$1 = function() {
  ...
  var _h = _vm.$createElement;
  var _c = _vm._self._c || _h;
  return _c("div", { class: _vm.rwClassName, style: _vm.rwStyle }, [_c("CanvasRuler", { attrs: { "vertical": _vm.vertical, "scale": _vm.scale, "width": _vm.width, "height": _vm.height, "start": _vm.start, "ratio": _vm.ratio, "select-start": _vm.selectStart, "select-length": _vm.selectLength, "palette": _vm.palette }, on: { "onAddLine": _vm.handleNewLine }, model: { value: _vm.showIndicator, callback: function($$v) {
    _vm.showIndicator = $$v;
  }, expression: "showIndicator" } }), _c("div", { directives: [{ name: "show", rawName: "v-show", value: _vm.isShowReferLine, expression: "isShowReferLine" }], staticClass: "lines" }, _vm._l(_vm.lines, function(v, i) {
    return _c("RulerLine", { key: v + i, attrs: { "index": i, "value": v >> 0, "scale": _vm.scale, "start": _vm.start, "thick": _vm.thick, "palette": _vm.palette, "vertical": _vm.vertical, "is-show-refer-line": _vm.isShowReferLine }, on: { "onRemove": _vm.handleLineRemove, "onRelease": _vm.handleLineRelease } });
  }), 1), _c("div", { directives: [{ name: "show", rawName: "v-show", value: _vm.showIndicator, expression: "showIndicator" }], staticClass: "indicator", style: _vm.indicatorStyle }, [_c("div", { staticClass: "value" }, [_vm._v(_vm._s(_vm.valueNum))])])], 1);
};
var staticRenderFns$1 = [];
var rulerWrapper_vue_vue_type_style_index_0_scoped_true_lang = "";
const __cssModules$1 = {};
var __component__$1 = /* @__PURE__ */ normalizeComponent(__vue2_script$1, render$1, staticRenderFns$1, false, __vue2_injectStyles$1, "271f0665", null, null);
...
var __vue2_script = defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const cornerStyle = computed(() => {
      return {
        backgroundImage: isShowReferLine.value ? `url(${eye64})` : `url(${closeEye64})`,
...
var render = function() {
  ...
  var _h = _vm.$createElement;
  var _c = _vm._self._c || _h;
  return _c("div", { staticClass: "style-ruler mb-ruler", attrs: { "id": "mb-ruler" } }, [_c("RulerWrapper", { attrs: { "vertical": false, "width": _vm.width, "height": _vm.thick, "is-show-refer-line": _vm.isShowReferLine, "thick": _vm.thick, "ratio": _vm.ratio, "start": _vm.startX, "lines": _vm.lines.h, "select-start": _vm.shadow.x, "select-length": _vm.shadow.width, "scale": _vm.scale, "palette": _vm.paletteCpu } }), _c("RulerWrapper", { attrs: { "vertical": true, "width": _vm.thick, "height": _vm.height, "is-show-refer-line": _vm.isShowReferLine, "thick": _vm.thick, "ratio": _vm.ratio, "start": _vm.startY, "lines": _vm.lines.v, "select-start": _vm.shadow.y, "select-length": _vm.shadow.height, "scale": _vm.scale, "palette": _vm.paletteCpu } }), _c("a", { staticClass: "corner", class: _vm.cornerActiveClass, style: _vm.cornerStyle, on: { "click": _vm.onCornerClick } })], 1);
};
var staticRenderFns = [];
