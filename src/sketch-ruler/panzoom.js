/*!simple-panzoom v1.0.12024年7月Fri Jul 05 2024 11:09:32 GMT+0800 (中国标准时间)制作*/
typeof window < 'u' &&
  (window.NodeList &&
    !NodeList.prototype.forEach &&
    (NodeList.prototype.forEach = Array.prototype.forEach),
  typeof window.CustomEvent != 'function' &&
    (window.CustomEvent = function (e, r) {
...
function ct(t, e) {
  let r = t.length
  for (; r--; ) if (t[r].pointerId === e.pointerId) return r
  return -1
}
function tt(t, e) {
  let r
  if (e.touches) {
    r = 0
    for (const c of e.touches) (c.pointerId = r++), tt(t, c)
    return
  }
...
const at = ['webkit', 'moz', 'ms'],
  T = {}
function et(t) {
  if (T[t]) return T[t]
  const e = gt()
  if (t in e) return (T[t] = t)
  const r = t[0].toUpperCase() + t.slice(1)
  let c = at.length
  for (; c--; ) {
    const h = `${at[c]}${r}`
    if (h in e) return (T[t] = h)
  }
}
function W(t, e) {
...
function Et(t, e) {
  for (let r = t; r != null; r = r.parentNode)
    if (xt(r, e.excludeClass) || e.exclude.indexOf(r) > -1) return !0
  return !1
}
const Pt = /^http:[\w\.\/]+svg$/
function Mt(t) {
...
function Ct(t, e) {
  ...
  if (t.nodeType !== 1) throw new Error('Panzoom requires an element with a nodeType of 1')
  if (!vt(t))
  ...
  const r = Mt(t),
    c = t.parentNode
  ;(c.style.overflow = e.overflow),
    (c.style.userSelect = 'none'),
    (c.style.touchAction = e.touchAction),
    ((e.canvas ? c : t).style.cursor = e.cursor),
    (t.style.userSelect = 'none'),
    (t.style.touchAction = e.touchAction),
    x(t, 'transformOrigin', typeof e.origin == 'string' ? e.origin : r ? '0 0' : '50% 50%')
  function h() {
    ;(c.style.overflow = ''),
      (c.style.userSelect = ''),
      (c.style.touchAction = ''),
  ...
  function y(n = {}) {
    for (const i in n) n.hasOwnProperty(i) && (e[i] = n[i])
    ;(n.hasOwnProperty('cursor') || n.hasOwnProperty('canvas')) &&
      ((c.style.cursor = t.style.cursor = ''), ((e.canvas ? c : t).style.cursor = e.cursor)),
      n.hasOwnProperty('overflow') && (c.style.overflow = n.overflow),
      n.hasOwnProperty('touchAction') &&
        ((c.style.touchAction = n.touchAction), (t.style.touchAction = n.touchAction))
  }
  let f = 0,
    p = 0,
    u = 1,
    A = !1
  Y(e.startScale, { animate: !1, force: !0 }),
    setTimeout(() => {
  ...
  function L(n, i, s) {
    ...
    return (
      requestAnimationFrame(() => {
        typeof i.animate == 'boolean' && (i.animate ? wt(t, i) : x(t, 'transition', 'none')),
          i.setTransform(t, d, i)
        const o = D(t)
  ...
  function R(n, i, s, d) {
    const o = { ...e, ...d },
      l = { x: f, y: p, opts: o }
    if (!o.force && (o.disablePan || (o.panOnlyWhenZoomed && u === o.startScale))) return l
    if (
      ((n = parseFloat(n)),
      (i = parseFloat(i)),
      o.disableXAxis || (l.x = (o.relative ? f : 0) + n),
      o.disableYAxis || (l.y = (o.relative ? p : 0) + i),
      o.contain)
    ) {
      const a = D(t),
        g = a.elem.width / u,
        ...
        b = (P - m) / 2
      if (o.contain === 'inside') {
        const k = (-a.elem.margin.left - a.parent.padding.left + v) / s,
          U =
            (a.parent.width -
              E -
        ...
        const G = (-a.elem.margin.top - a.parent.padding.top + b) / s,
          _ =
            (a.parent.height -
              P -
  ...
  function X(n, i) {
    const s = { ...e, ...i },
      d = { scale: u, opts: s }
    if (!s.force && s.disableZoom) return d
    let o = e.minScale,
      l = e.maxScale
    if (s.contain) {
      const a = D(t),
        ...
        m = a.elem.height / u
      if (g > 1 && m > 1) {
        const E = a.parent.width - a.parent.border.left - a.parent.border.right,
          P = a.parent.height - a.parent.border.top - a.parent.border.bottom,
          v = E / g,
          b = P / m
        e.contain === 'inside'
          ? (l = Math.min(l, v, b))
          : e.contain === 'outside' && (o = Math.max(o, v, b))
      }
    }
  ...
  function H(n, i, s, d) {
    const o = R(n, i, u, s)
    return f !== o.x || p !== o.y
      ? ((f = o.x), (p = o.y), L('panzoompan', o.opts, d))
      : { x: f, y: p, scale: u, isSVG: r, originalEvent: d }
  }
  function Y(n, i, s) {
    const d = X(n, i),
      o = d.opts
    if (!o.force && o.disableZoom) return
    n = d.scale
    let l = f,
      a = p
    if (o.focal) {
  ...
  function B(n, i, s, d) {
    ...
    let a =
        ...
        o.parent.border.left -
        o.elem.margin.left,
      g = i.clientY - o.parent.top - o.parent.padding.top - o.parent.border.top - o.elem.margin.top
    r || ((a -= o.elem.width / u / 2), (g -= o.elem.height / u / 2))
    const m = {
      x: (a / l.width) * (l.width * n),
      y: (g / l.height) * (l.height * n)
    }
    return Y(n, { ...s, animate: !1, focal: m }, d)
  }
  function ut(n, i) {
    n.preventDefault()
    const s = { ...e, ...i, animate: !1 },
      o = (n.deltaY === 0 && n.deltaX ? n.deltaX : n.deltaY) < 0 ? 1 : -1,
      l = X(u * Math.exp((o * s.step) / 3), s).scale
    return B(l, n, s, n)
  }
  function ft(n) {
  ...
  const w = []
  function V(n) {
    if (Et(n.target, e)) return
    tt(w, n),
      (A = !0),
      e.handleStartEvent(n),
      (z = f),
      (O = p),
      C('panzoomstart', { x: f, y: p, scale: u, isSVG: r, originalEvent: n }, e)
    const i = it(w)
    ;(S = i.clientX), ($ = i.clientY), (rt = u), (N = J(w))
  }
  function Z(n) {
    if (!A || z === void 0 || O === void 0 || S === void 0 || $ === void 0) return
    tt(w, n)
    const i = it(w),
      s = w.length > 1
    let d = u
  ...
  function q(n) {
    w.length === 1 && C('panzoomend', { x: f, y: p, scale: u, isSVG: r, originalEvent: n }, e),
      pt(w, n),
      A && ((A = !1), (z = O = S = $ = void 0))
  }
  let F = !1
  function ot() {
    F ||
      ((F = !0),
      K('down', e.canvas ? c : t, V),
      K('move', document, Z, { passive: !0 }),
      K('up', document, q, { passive: !0 }))
  }
  function ht() {
